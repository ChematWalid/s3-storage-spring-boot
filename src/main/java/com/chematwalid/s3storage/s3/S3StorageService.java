package com.chematwalid.s3storage.s3;

import com.chematwalid.s3storage.StorageResource;
import com.chematwalid.s3storage.StorageResult;
...
import com.chematwalid.s3storage.exception.StorageException;
 ...
 * MUST consume the stream passed to it directly (which was wrapped in {@code SizeLimitingInputStream}
