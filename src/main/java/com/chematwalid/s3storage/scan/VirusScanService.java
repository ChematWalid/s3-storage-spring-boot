...
import com.chematwalid.s3storage.exception.VirusScanException;
...
public class VirusScanService {
    ...
    public VirusScanService(StorageProperties properties, VirusScanner virusScanner) {
        this(properties, virusScanner, StorageMetrics.noop());
    }
    ...
    public VirusScanService(StorageProperties properties, VirusScanner virusScanner,
        ...
        if (metrics == null) {
            throw new IllegalArgumentException("StorageMetrics cannot be null");
        }
    ...
    private void performScan(InputStream content, String filename) {
        ...
        try {
            ...
            metrics.recordVirusScan("SCAN_ERROR");
            throw ex;
        }
        ...
        if (result.isError()) {
            ...
            if (failOpen) {
                metrics.recordVirusScan("SCAN_ERROR_ALLOWED");
                ...
                metrics.recordVirusScan("SCAN_ERROR_REJECTED");
