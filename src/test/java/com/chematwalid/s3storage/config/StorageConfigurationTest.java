...
class StorageConfigurationTest {
    ...
    void createsProviderIndependentAndInMemoryBeans() {
        ...
        ObjectProvider<StorageMetrics> metricsProvider = objectProvider(StorageMetrics.noop());
        ...
        assertThat(configuration.virusScanService(properties, configuration.virusScanner(properties), metricsProvider))
    ...
    /** Creates a simple single-value {@link ObjectProvider} for use in unit tests. */
