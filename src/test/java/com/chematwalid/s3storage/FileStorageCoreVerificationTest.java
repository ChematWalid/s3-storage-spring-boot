...
import com.chematwalid.s3storage.exception.FileNotFoundStorageException;
    ...
    void v5_spoofedFileType_shouldBeDetectedAndRejectedByContentSniffing() {
        ...
        assertThatThrownBy(() -> validator.validateAndSanitize(
                ...
                .satisfies(ex -> {
                    ...
                    System.out.println("HTTP Status: " + ((UnsupportedFileTypeException) ex).getHttpStatusCode());
    ...
    void testAllowedTypeMismatch_whenTrueContentIsPngButDeclaredIsJpeg_shouldRejectWithUnsupportedFileTypeException() {
        ...
        assertThatThrownBy(() -> validator.validateAndSanitize(
                ...
                .satisfies(ex -> {
                    ...
                    System.out.println("Status: " + ((UnsupportedFileTypeException) ex).getHttpStatusCode());
